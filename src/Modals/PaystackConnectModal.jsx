  ...
  const handleSubmit =
    async (e) => {
      ...
      if (
        ...
        setError(
          "Please enter your business or account name."
        );
      ...
      >
        ...
        {connected && payout ? (
          ...
          >
            ...
            >
              Your bank details are sent securely
              to Paystack. Your account number is
              not stored in your database. We only
              store the Paystack payout connection.
            </p>
